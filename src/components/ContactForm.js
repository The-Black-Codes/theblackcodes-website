...
const ContactForm = (_) => {
  ...
  return (
    <Form>
      ...
      <ReCAPTCHA
        className="mb-3"
        sitekey="6Lf9zvAUAAAAAB0WcZEbWKfAS05Zg0QCeOSMLaJS"
        onChange={(event) => setForm({ ...form, captcha: event })}
      />

      <Button block color="primary" disabled={validate()} onClick={submitForm}>
        Submit
      </Button>
    </Form>
  );
